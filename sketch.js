...
function setup() {
	...
	Rbody=Bodies.rectangle(width/2+100,height-90,20,100,{isStatic:true} );
	World.add(world,Rbody)
	
	Mbody=Bodies.rectangle(width/2,height-60,160,20,{isStatic:true} );
	//Matter.Body.setAngle(Mbody,180);
	World.add(world,Mbody)
 Lbody=Bodies.rectangle(width/2-100,height-90,20,100,{isStatic:true} );
